...
A lightweight **Python-based port scanner** that checks for open ports on a target host.
This project demonstrates basic **socket programming, networking, and multithreading in Python**.
